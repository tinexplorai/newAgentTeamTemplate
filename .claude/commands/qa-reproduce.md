...
docs, including `project_code/documentation/source_inventory.md` and
`design_spec.md` when the bug is visual or interaction-related. QA should run
the smallest targeted reproduction needed and write
